...
class EditPassConfirmPage extends StatefulWidget {
  static String phoneNumber;

  static String phoneCode;

  EditPassConfirmPage(String phone, String code) {
    phoneNumber = phone;
    phoneCode = code;
  }

  @override
  State<StatefulWidget> createState() => EditPassConfirm(phoneNumber, phoneCode);
}
...
class EditPassConfirm extends State<EditPassConfirmPage> {
  ...
  EditPassConfirm(String phone, String code) {
    phoneNumber = phone;
    phoneCode = code;
  }
  ...
  handleMobileNext() async {
    ...
    Map result = await request.post('/passport/login/modify/pw', {'mobile': phoneNumber.trim(), 'verifyCode': phoneCode.trim(), 'password': password, 'confirm': passwordConfirm});
    requestDoneShowToast(result, '修改成功，自动登录', (){
