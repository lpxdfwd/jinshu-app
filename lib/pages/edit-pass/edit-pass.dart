...
import 'package:jinshu_app/pages/edit-pass/edit-code.dart';
...
class EditPassState extends State<EditPassPage> {
  ...
  handleMobileNext() async {
    ...
    requestDoneShowToast(result, '', () {
      Navigator.pushReplacement(context, new MaterialPageRoute(builder: (BuildContext context) => EditCodePage(phoneNumber)));
    });
  }
